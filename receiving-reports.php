              ...
              <div class="box">
                <form action="">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title"> Receiving Reports for COS</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group "><!-- has-success -->
                              <input type="text" class="form-control" id="" placeholder="Invoice Number">
                            </div>
                            <div class="form-group "><!-- has-success -->
                              <input type="text" class="form-control" id="" placeholder="RR No.">
                            </div>
                            <div class="form-group "><!-- has-success -->
